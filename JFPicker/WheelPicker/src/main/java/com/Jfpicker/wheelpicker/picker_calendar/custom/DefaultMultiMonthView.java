 ...
 * 自定义多选的月视图
 */
public class DefaultMultiMonthView extends MultiMonthView {
    ...
    public DefaultMultiMonthView(Context context) {
        super(context);
    ...
    protected boolean onDrawSelected(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme,
        ...
        mSelectedPaint.setColor(DialogConfig.getDefault().getCalendarMultiColor());
        if (isSelectedPre) {
            if (isSelectedNext) {
